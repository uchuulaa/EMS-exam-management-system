...
public class LoginInstructor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LoginInstructor frame = new LoginInstructor();
	...
	public LoginInstructor() {
		...
		JLabel titleLabel = new JLabel("Instructor Login Page");
		...
		iconlbl.setIcon(new ImageIcon(LoginInstructor.class.getResource("../Images/index student.png")));
		iconlbl.setBounds(467, 92, 101, 124);
		panel.add(iconlbl);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					PreparedStatement stmt = con
							.prepareStatement("SELECT * FROM instructor WHERE email = ? AND password = ?");
					...
					JOptionPane.showMessageDialog(null,
							"<html><b style=\"color:red; font-size: 10px\">Something went wrong connecting with database</b></html>",
		...
		loginbtn.setIcon(new ImageIcon(LoginInstructor.class.getResource("../Images/login.png")));
		loginbtn.setBounds(445, 466, 109, 29);
		panel.add(loginbtn);
		...
		btnBack.setIcon(new ImageIcon(LoginInstructor.class.getResource("../Images/Back.png")));
		btnBack.setFont(new Font("Tahoma", Font.BOLD, 14));
		btnBack.setBounds(564, 466, 109, 29);
		panel.add(btnBack);
	}
}
